...
let ExpenseEntryComponent = class ExpenseEntryComponent {
    ...
    get entryParameter() { return this.entryParam; }
    ;
    set entryParameter(param) {
        param.amount = 10;
...
let SampleProfileFormComponent = class SampleProfileFormComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let TestingChildComponent = class TestingChildComponent {
    constructor() {
